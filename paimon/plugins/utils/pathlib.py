...
from paimon.utils import humanbytes, time_formatter, sort_file_name_key
...
@paimon.on_cmd(r'drename ([^|]+)\|([^|]+)', about={  # noqa
...
@paimon.on_cmd(r'split (\d+) ([\s\S]+)', about={
    'header': "Split files",
