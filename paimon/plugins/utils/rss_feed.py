...
from paimon import paimon, Message, Config, logging, get_collection, pool
...
"""
    ...
    for chat_id in RSS_CHAT_ID:
        ...
        try:
            ...
            UserNotParticipant, paimonBotNotFound
        ):
