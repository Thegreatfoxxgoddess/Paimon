...
from paimon import paimon, Config, Message, get_collection
...
@paimon.on_cmd('dthumb', about={'header': "Delete thumbnail"}, allow_channels=False)
...
@paimon.on_cmd('vthumb', about={'header': "View thumbnail"}, allow_channels=False)
