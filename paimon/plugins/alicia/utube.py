...
from paimon.utils import time_formatter, humanbytes, import_ytdl
...
@paimon.on_cmd("ytinfo", about={'header': "Get info from ytdl",
...
@paimon.on_cmd("ytdl", about={'header': "Download from youtube",
...
@paimon.on_cmd("ytdes", about={'header': "Get the video description",
                               'description': 'Get information of the link without downloading',
