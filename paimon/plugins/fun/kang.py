...
from paimon import paimon, Message, config
from .. import kang
...
async def kang_(message: Message):
    ...
    media = await paimon.download_media(message=replied, file_name=config.Dynamic.DOWN_PATH)
    if not media:
