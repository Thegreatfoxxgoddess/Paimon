...
@paimon.on_cmd(
    ...
    about={
        ...
        "examples": [
            "{tr}eval print('paimon')",
            "{tr}eval -s print('paimon')",
            "{tr}eval 5 + 6",
            "{tr}eval -s 5 + 6",
        ],
    },
...
async def eval_(message: Message):
    ...
    async def aexec(code):
        head = "async def __aexec(paimon, message):\n "
        if "\n" in code:
        ...
        return await locals()["__aexec"](paimon, message)
