...
PATH = "./paimon/xcache/spoiler_db.json"
...
if paimon.has_bot:
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^getl([\S]+)$"))
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^nobtnspoiler([\S]+)$"))
