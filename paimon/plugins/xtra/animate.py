...
@paimon.on_cmd("think$", about={"header": "Pretending to Think"})
...
@paimon.on_cmd("lmaos$", about={"header": "lmaos Bruh! xD Lol"})
...
@paimon.on_cmd("nothappy$", about={"header": "Mood Swing"})
...
@paimon.on_cmd("muah$", about={"header": "LUV"})
...
@paimon.on_cmd("heart$", about={"header": "Rainbow hearts"})
...
@paimon.on_cmd("gym$", about={"header": "Get Active!, Stay healthy 💪"})
...
@paimon.on_cmd("smoon$", about={"header": "Another kensar moon animation"})
...
@paimon.on_cmd("tmoon$", about={"header": "Another kensar moon animation"})
