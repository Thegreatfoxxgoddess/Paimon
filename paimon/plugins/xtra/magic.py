...
from paimon.plugins.utils.circle import crop_vid
from paimon.utils import media_to_image, runcmd, safe_filename
...
async def spinn(message: Message):
    ...
    path = "paimon/xcache/rotate-disc/"
