...
@paimon.on_cmd("yp$", about={"header": "Barra de progresso do ano"})
...
@paimon.on_cmd("fds", about={"header": "fodase?"})
...
@paimon.on_cmd("f", about={"header": "f"})
...
@paimon.on_cmd("iam", about={"header": "i am gay?"})
async def iam_(message: Message):
    ...
    if not reply_:
        ...
        return
    user_ = await paimon.get_users(reply_.from_user.id)
...
@paimon.on_cmd("aa", about={"header": "aaaaaaaa"}, allow_via_bot=False)
...
@paimon.on_cmd("(oof)$", about={"header": "ooooooof"}, trigger="", allow_via_bot=False)
...
@paimon.on_cmd("snake", about={"header": "sneeeeak"})
...
@paimon.on_cmd("lol", about={"header": "biglol"})
...
@paimon.on_cmd("(bd)$", about={"header": "bom diaaa"}, trigger="", allow_via_bot=False)
...
@paimon.on_cmd("(bn)$", about={"header": "boa noitee"}, trigger="", allow_via_bot=False)
...
async def hack_func(message: Message):
    ...
    animation_chars = [
        ...
        "`root@paimon:~# ls`",
        "`root@paimon:~# ls\n\n  usr  ghost  codes  \n\nroot@paimon:~#`",
        "`root@paimon:~# ls\n\n  usr  ghost  codes  \n\nroot@paimon:~# # So Let's Hack it ...`",
        "`root@paimon:~# ls\n\n  usr  ghost  codes  \n\nroot@paimon:~# # So Let's Hack it ...\nroot@paimon:~# `",
        "`root@paimon:~# ls\n\n  usr  ghost  codes  \n\nroot@paimon:~# # So Let's Hack it ...\nroot@paimon:~# touch setup.py`",
        "`root@paimon:~# ls\n\n  usr  ghost  codes  \n\nroot@paimon:~# # So Let's Hack it ...\nroot@paimon:~# touch setup.py\n\nsetup.py deployed ...`",
        "`root@paimon:~# ls\n\n  usr  ghost  codes  \n\nroot@paimon:~# # So Let's Hack it ...\nroot@paimon:~# touch setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...`",
        "`root@paimon:~# ls\n\n  usr  ghost  codes  \n\nroot@paimon:~# # So Let's Hack it ...\nroot@paimon:~# touch setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...\n\nroot@paimon:~# trap whoami`",
        "`root@paimon:~# ls\n\n  usr  ghost  codes  \n\nroot@paimon:~# # So Let's Hack it ...\nroot@paimon:~# touch setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...\n\nroot@paimon:~# trap whoami\n\nwhoami=user`",
        "`root@paimon:~# ls\n\n  usr  ghost  codes  \n\nroot@paimon:~# # So Let's Hack it ...\nroot@paimon:~# touch setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...\n\nroot@paimon:~# trap whoami\n\nwhoami=user\nboost_trap on force ...`",
...
@paimon.on_cmd("sexo", about={"header": "sexoooooooooooo"})
async def snake_(message: Message):
    """muito sexo"""
    out = f"""
