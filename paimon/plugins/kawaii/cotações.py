...
@paimon.on_cmd("cota", about={"header": "Mostra a cotação das moedas atualmente"})
async def cota_inline(message: Message):
    await message.edit("`Obtendo informações de moedas...`")
    bot = await paimon.bot.get_me()
    x = await paimon.get_inline_bot_results(bot.username, "cota")
...
if paimon.has_bot:
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^back_moedas$"))
    async def back_coin(_, callback_query: CallbackQuery):
        ...
        if u_id in Config.OWNER_ID or u_id in Config.SUDO_USERS:
            ...
            await paimon.bot.edit_inline_text(
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^moeda_internacionais$"))
    ...
    # Coin list
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^coin_dol$"))
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^coin_eur$"))
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^coin_lib$"))
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^coin_iene$"))
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^crypto_moedas$"))
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^crypt_btc$"))
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^crypt_eth$"))
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^crypt_xrp$"))
    ...
    @paimon.bot.on_callback_query(filters.regex(pattern=r"^crypt_doge$"))
